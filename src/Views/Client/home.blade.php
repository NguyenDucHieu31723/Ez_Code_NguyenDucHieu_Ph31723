                ...
                <div class="col-md-8 col-sm-12">
                    <div class="about-info">
                        <div class="section-title wow fadeInUp" data-wow-delay="0.2s">
                            <h2>{{ $courseFirstLatest['c_name'] }}</h2>
                        </div>
                        <div class="wow fadeInUp" data-wow-delay="0.4s">
                            <p>Next.js là một framework JavaScript mã nguồn mở được xây dựng trên nền tảng của React, được sử dụng để phát triển các ứng dụng web phía client và phía server...</p>
                            <p><a href="/course/{{ $courseFirstLatest['c_id'] }}/show">Xem thêm . . .</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="wow fadeInUp about-image" data-wow-delay="0.6s">
                        <img src="{{ $courseFirstLatest['c_thumbnail'] }}" class="img-responsive" alt="">
                    </div>
                </div>
